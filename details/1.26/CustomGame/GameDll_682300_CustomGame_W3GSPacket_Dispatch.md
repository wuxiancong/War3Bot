...
6F6823EC  | E8 6F88FFFF             | call game.6F67AC60                  | 0x08 -> W3GS_PLAYERLOADED(加载完毕)
6F6823F1  | 5E                      | pop esi                             |
...
| **07** 	| **0x08** 	| `W3GS_PLAYERLOADED`	| `6F67AC60` 				| 加载完毕					|
...
| **1D** 	| **0x43** 	| `W3GS_MAPPART` 		| `6F67F0E0` 				| 地图分片					|
