...
public:
    ...
    PreJoinData getClientIdByPreJoinName(const QString &playerName);
    ...
    bool sendStartWar3(const QString &clientId, quint8 status, quint8 errorCode, quint8 current, quint8 required, const QByteArray &whitelist);
...
private:
    ...
    QMap<QString, PreJoinData> m_preJoins;
