...
// 游戏类型枚举
enum BaseGameType {
    Type_Unknown = 0x00, Type_D2_ClosedBN = 0x00, Type_D2_OpenBN = 0x04,
    Type_Melee = 0x02, Type_FFA = 0x03, Type_1v1 = 0x04, Type_CTF = 0x05,
    Type_Greed = 0x06, Type_Slaughter = 0x07, Type_SuddenDeath = 0x08,
    Type_Ladder = 0x09, Type_IronManLadder = 0x10, Type_UMS = 0x0A,
    Type_TeamMelee = 0x0B, Type_TeamFFA = 0x0C, Type_TeamCTF = 0x0D,
    Type_TopVsBottom = 0x0F, Type_PGL = 0x20
};

enum GameTypeFlags {
    Flag_None = 0x0000, Flag_Expansion = 0x2000,
    Flag_FixedTeams = 0x4000, Flag_Official = 0x8000
};

enum ComboGameType {
    Game_TFT_Custom = 0x2001, Game_TFT_Official = 0xC009, Game_RoC_Custom = 0x0001
};

enum SubGameType {
    SubType_None = 0x00, SubType_Blizzard = 0x42, SubType_Scenario = 0x43,
    SubType_Internet = 0x49, SubType_Load = 0x4C, SubType_Save = 0x53
};

enum GameState {
    State_None = 0x00, State_Private = 0x01, State_Full = 0x02,
    State_HasOtherPlayers = 0x04, State_InProgress = 0x08,
    State_DisconnectIsLoss = 0x10, State_Replay = 0x80,
...
enum ProviderVersion {
    Provider_All_Bits = 0xFFFFFFFF, Provider_RoC = 0x00000000,
    Provider_SC_BW = 0x000000FF, Provider_TFT_New = 0x000003FF
};

enum LadderType {
    Ladder_None = 0x00000000, Ladder_Standard = 0x00000001, Ladder_IronMan = 0x00000003
};
...
public:
    ...
    // IP 转换辅助 (可根据需要保留在 public 或移至 private)
