...
public:
    ...
    // 设置 NetManager 指针
    void setNetManager(NetManager* netManager) { m_netManager = netManager; }                                   // 设置网络管理
...
private:
    ...
    // --- 内部网络处理 ---
    void sendJoinMessage(const QString &playerName);
    void sendLeaveMessage(const QString &playerName, const QString &newHostName);
    void sendChatMessage(quint8 targetPid, const MultiLangMsg& msg);
